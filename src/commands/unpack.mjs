...
await extractPack("./packs/items", "./src/packs/items", { nedb: false,log: true,documentType: "Item" });
await extractPack("./packs/playbooks", "./src/packs/playbooks", { nedb: false,log: true,documentType: "Actor" });